...
myres.mm <- IntLIM::RunIntLim(inputData = inputDatafilt,stype="PBO_vs_Leukemia", metabolite.pairs = TRUE)
myres.gm.continuous <- IntLIM::RunIntLim(inputData = inputDatafilt,stype="cellnbr", continuous = TRUE)
myres.mm.continuous <- IntLIM::RunIntLim(inputData = inputDatafilt,stype="cellnbr", metabolite.pairs = TRUE, continuous = TRUE)
```
