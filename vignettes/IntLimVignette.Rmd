...
predictions_graph <- IntLIM::ProjectPredictionsOntoGraph(list(predictions_gm, predictions_mm, predictions_mg, predictions_gg), coreg_graph)
IntLIM::SaveGraphPredictionPlots(graphWithPredictions=predictions_graph, 
