...
IntLIM::SaveGraphPredictionPlots(graphWithPredictions=prediction_graphs, 
                         inputData=inputDatafilt, stype="PBO_vs_Leukemia", 
                         dirName=paste(result_dir, "Predictions", sep = "\\"),
                                     continuous = FALSE)
```
...
modelInputs <- IntLIM::formatTrainingInput(predictionGraphs=prediction_graphs, inputData = inputDatafilt, stype = "PBO_vs_Leukemia", stype.class = "categorical")

# Create pooling filter.
poolingFilter <- IntLIM::CreatePoolingFilter(modelInputs = modelInputs, k = length(prediction_graphs), poolType = "median")
