...
```{r}
myres.gm <- IntLIM::RunIntLim(inputData = inputDatafilt,stype="PBO_vs_Leukemia", save.covar.pvals = TRUE)
myres.mm <- IntLIM::RunIntLim(inputData = inputDatafilt,stype="PBO_vs_Leukemia", metabolite.pairs = TRUE, save.covar.pvals = TRUE)
myres.gm.continuous <- IntLIM::RunIntLim(inputData = inputDatafilt,stype="cellnbr", continuous = TRUE, save.covar.pvals = TRUE)
myres.mm.continuous <- IntLIM::RunIntLim(inputData = inputDatafilt,stype="cellnbr", metabolite.pairs = TRUE, continuous = TRUE, save.covar.pvals = TRUE)
```
