...
These lines are commented out to speed up build time for the package. Uncomment
to run.
```{r eval = FALSE}
...
summary <- IntLIM::PermutationCountSummary(permResults = perm.res, inputResults = myres.sig,
                              plot = TRUE)
```
